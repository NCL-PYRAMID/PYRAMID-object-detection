...
if __name__ == '__main__':
    ...
    roitransformer_dota_1_0 = DetectorModel(r'configs/DOTA/faster_rcnn_RoITrans_r50_fpn_1x_dota.py',
                                            r'checkpoints/faster_rcnn_RoITrans_r50_fpn_1x_dota-20211001T092200Z-001/faster_rcnn_RoITrans_r50_fpn_1x_dota/faster_rcnn_RoITrans_r50_fpn_1x_dota.pth')
    roitransformer_dota_1_5 = DetectorModel(r'configs/DOTA1_5/faster_rcnn_RoITrans_r50_fpn_1x_dota1_5.py',
                                            r'checkpoints/faster_rcnn_RoITrans_r50_fpn_1x_dota1_5-20211001T092744Z-001/faster_rcnn_RoITrans_r50_fpn_1x_dota1_5/faster_rcnn_RoITrans_r50_fpn_1x_dota1_5.pth')
